      ...
      <main className="max-w-7xl mx-auto py-20 px-4 pt-32">
        <nav className="text-sm mb-8">
          <ol className="flex items-center space-x-2 text-gray-500">
            <li><Link to="/merchandise" className="hover:text-blue-600">Merchandise</Link></li>
            <li>/</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              {merchandiseItem.colors.map((c: any) => (
                <img
                  ...
                  className={`w-20 h-20 rounded-lg cursor-pointer border-2 transition-all ${
                    selectedColor.name === c.name ? "border-blue-600 scale-105" : "border-transparent opacity-70"
                  }`}
                />
              ))}
            </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-2xl text-blue-600 font-bold">₦{unitPrice.toLocaleString()}</p>
            ...
            <form onSubmit={handleBuyNow} className="bg-white p-6 rounded-xl shadow-md space-y-4">
              ...
              <div className="flex gap-4">
                <select
                  ...
                  value={formData.size}
                  onChange={handleInputChange}
                  className="flex-1 px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-700"
                >
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-24 px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-700"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full p-3 border rounded-lg bg-gray-50 cursor-not-allowed font-semibold text-blue-600"
                />
              </div>
